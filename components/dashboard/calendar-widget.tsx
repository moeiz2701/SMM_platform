...
export default function CalendarWidget() {
  ...
  const sampleTasks: { [key: string]: Task[] } = {
    "15": [
      { id: 1, title: "Client Meeting", time: "10:00 AM", type: "meeting" },
      { id: 2, title: "Instagram Post", time: "2:00 PM", type: "post" },
    ],
    "18": [{ id: 3, title: "Campaign Deadline", time: "5:00 PM", type: "deadline" }],
    "22": [
      { id: 4, title: "Content Review", time: "11:00 AM", type: "meeting" },
      { id: 5, title: "Facebook Post", time: "3:00 PM", type: "post" },
    ],
  }
